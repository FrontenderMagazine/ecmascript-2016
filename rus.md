...
* [Array.prototype.includes][4] (Разработаны Домеником Дениколой (Domenic Denicola) и Риком Валдроном (Rick Waldron))
* [Экспоненциальный оператор][5] (Разработан Риком Валдроном)

1 марта был сделан снепшот [черновика спецификации ECMA-262][2]. Затем начнется процесс редактирования. И, наконец, 
